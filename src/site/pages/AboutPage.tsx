...
export function AboutPage() {
  ...
  return (
    <SiteShell>
      <PageIntro tone="ink" eyebrow="About Artifact" title="One integrated practice." intro="Digital learning decisions are often divided between strategy, instructional design, UX, visual design, development, multimedia, platforms and measurement. Artifact connects them because each decision changes what is worth doing in the others." />

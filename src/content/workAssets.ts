...
export const workVisuals = {
  ...
  wellbeingStudio: {
    ...
    status: "representative",
    alt: "A programme hub with a monthly theme, featured practice, upcoming live session and participation progress.",
    caption: "Artifact programme prototype · not a conventional course",
